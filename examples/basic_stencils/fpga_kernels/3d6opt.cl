/**
 * @file basic_stencils/fpga_kernels/3d6opt.cl
 * @brief Epsilod: Example with several key stencils. Optimized FPGA 3d6 kernel code.
 *
...
// 3D compact, radius 1: 6-point star, no corners
EPSILOD_FPGA_BASIC_STENCIL(3d6, matrix, matrixCopy) {
...
EPSILOD_FPGA_BASIC_STENCIL(3d6_yBorder, matrix, matrixCopy) {
...
EPSILOD_FPGA_BASIC_STENCIL(3d6_xBorder, matrix, matrixCopy) {
	// We know some of these sizes at compile time:
