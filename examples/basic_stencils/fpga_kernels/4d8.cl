/**
 * @file basic_stencils/fpga_kernels/4d8.cl
 * @brief Epsilod: Example with several key stencils. FPGA 4d8 kernel code.
 *
...
CTRL_KERNEL_FN(updateCell_4d8, FPGA, NDRANGE, KHitTileR_arg(float, matrix), KHitTileR_arg(float, matrixCopy),
...
CTRL_KERNEL_FN(updateCell_4d8_yBorder, FPGA, NDRANGE, KHitTileR_arg(float, matrix), KHitTileR_arg(float, matrixCopy),
			   K_arg(EpsilodCoords, global_coords), KHitTileR_arg(float, stencil), K_arg(float, factor),
			   K_arg(Epsilod_ext, ext_params)) {
	for (int l = 0; l < hit_tileDimCard(matrix, 3); l++)
		hit(matrix, thr_i, thr_j, thr_k, l) =
...
CTRL_KERNEL_FN(updateCell_4d8_xBorder, FPGA, NDRANGE, KHitTileR_arg(float, matrix), KHitTileR_arg(float, matrixCopy),
			   K_arg(EpsilodCoords, global_coords), KHitTileR_arg(float, stencil), K_arg(float, factor),
			   K_arg(Epsilod_ext, ext_params)) {
	for (int l = 0; l < hit_tileDimCard(matrix, 3); l++)
		hit(matrix, thr_i, thr_j, thr_k, l) =
...
CTRL_KERNEL_FN(updateCell_4d8_zBorder, FPGA, NDRANGE, KHitTileR_arg(float, matrix), KHitTileR_arg(float, matrixCopy),
			   K_arg(EpsilodCoords, global_coords), KHitTileR_arg(float, stencil), K_arg(float, factor),
			   K_arg(Epsilod_ext, ext_params)) {
	for (int l = 0; l < hit_tileDimCard(matrix, 3); l++)
		hit(matrix, thr_i, thr_j, thr_k, l) =
...
__CTRL_FPGA_KERNEL_OPTIMIZE_FOR(8, 64, 4, 1)
__CTRL_FPGA_KERNEL_REPLICATE(2, 2, 1)
CTRL_KERNEL_FN(updateCell_4d8_wBorder, FPGA, NDRANGE, KHitTileR_arg(float, matrix), KHitTileR_arg(float, matrixCopy),
			   K_arg(EpsilodCoords, global_coords), KHitTileR_arg(float, stencil), K_arg(float, factor),
			   K_arg(Epsilod_ext, ext_params)) {
	for (int l = 0; l < hit_tileDimCard(matrix, 3); l++)
		hit(matrix, thr_i, thr_j, thr_k, l) =
