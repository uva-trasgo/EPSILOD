/**
 * @file basic_stencils/fpga_kernels/2d4opt.cl
...
// SR dims:      yyyyyyy   xxxxxxxxxxxxxxxx  (i.e., does not include last row)
...
EPSILOD_FPGA_BASIC_STENCIL(2d4, matrix, matrixCopy) {
...
EPSILOD_FPGA_BASIC_STENCIL(2d4_xBorder, matrix, matrixCopy) {
