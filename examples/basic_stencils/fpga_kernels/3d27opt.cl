/**
 * @file basic_stencils/fpga_kernels/3d27opt.cl
 * @brief Epsilod: Example with several key stencils. Optimized FPGA 3d27 kernel code.
 *
...
#define SR_BASE      (2 * RAD * HALO_BLOCK_WIDTH_X * HALO_BLOCK_WIDTH_Y + 2 * RAD * HALO_BLOCK_WIDTH_X + 2 * RAD)
...
#define COMPUTE_X_OFFSET (-RAD)
#define COMPUTE_Y_OFFSET (-RAD)

// 3D compact, radius 1: 27-point star, corners included
EPSILOD_FPGA_BASIC_STENCIL(3d27, matrix, matrixCopy) {
...
EPSILOD_FPGA_BASIC_STENCIL(3d27_yBorder, matrix, matrixCopy) {
...
EPSILOD_FPGA_BASIC_STENCIL(3d27_xBorder, matrix, matrixCopy) {
	// We know some of these sizes at compile time:
