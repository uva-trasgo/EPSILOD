/**
 * @file basic_stencils/fpga_kernels/3dF7opt.cl
 * @brief Epsilod: Example with several key stencils. Optimized FPGA 3dF7 kernel code.
 *
...
#define BLOCK_WIDTH_X      (HALO_BLOCK_WIDTH_X - RAD) // Without halos
#define BLOCK_WIDTH_Y      (HALO_BLOCK_WIDTH_Y - RAD) // Without halos
...
#define SR_BASE      (RAD * HALO_BLOCK_WIDTH_X * HALO_BLOCK_WIDTH_Y)
...
EPSILOD_FPGA_BASIC_STENCIL(3dF7, matrix, matrixCopy) {
...
EPSILOD_FPGA_BASIC_STENCIL(3dF7_yBorder, matrix, matrixCopy) {
...
EPSILOD_FPGA_BASIC_STENCIL(3dF7_xBorder, matrix, matrixCopy) {
	// We know some of these sizes at compile time:
