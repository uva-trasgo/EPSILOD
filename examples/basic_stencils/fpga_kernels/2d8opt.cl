/**
 * @file basic_stencils/fpga_kernels/2d8opt.cl
 * @brief Epsilod: Example with several key stencils. Optimized FPGA 2d8 kernel code.
 *
...
#define SR_BASE (2 * RAD * HALO_BLOCK_WIDTH + 2 * RAD) // Elements whose input is a posterior shift
// SR dims:      yyyyyyy   xxxxxxxxxxxxxxxx   ccccccc     register element
...
EPSILOD_FPGA_BASIC_STENCIL(2d8, matrix, matrixCopy) {
...
#define SR_BASE_XBORDER (2 * RAD * HALO_BLOCK_WIDTH_XBORDER + 2 * RAD)
...
EPSILOD_FPGA_BASIC_STENCIL(2d8_xBorder, matrix, matrixCopy) {
