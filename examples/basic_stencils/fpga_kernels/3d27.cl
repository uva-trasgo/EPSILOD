/**
 * @file basic_stencils/fpga_kernels/3d27.cl
...
CTRL_KERNEL_FN(updateCell_3d27, FPGA, NDRANGE, KHitTileR_arg(float, matrix), KHitTileR_arg(float, matrixCopy),
...
CTRL_KERNEL_FN(updateCell_3d27_yBorder, FPGA, NDRANGE, KHitTileR_arg(float, matrix), KHitTileR_arg(float, matrixCopy),
			   K_arg(EpsilodCoords, global_coords), KHitTileR_arg(float, stencil), K_arg(float, factor),
			   K_arg(Epsilod_ext, ext_params)) {
	hit(matrix, thr_i, thr_j, thr_k) = (hit(matrixCopy, thr_i - 1, thr_j - 1, thr_k - 1) +
										hit(matrixCopy, thr_i - 1, thr_j - 1, thr_k) +
...
CTRL_KERNEL_FN(updateCell_3d27_xBorder, FPGA, NDRANGE, KHitTileR_arg(float, matrix), KHitTileR_arg(float, matrixCopy),
			   K_arg(EpsilodCoords, global_coords), KHitTileR_arg(float, stencil), K_arg(float, factor),
			   K_arg(Epsilod_ext, ext_params)) {
	hit(matrix, thr_i, thr_j, thr_k) = (hit(matrixCopy, thr_i - 1, thr_j - 1, thr_k - 1) +
										hit(matrixCopy, thr_i - 1, thr_j - 1, thr_k) +
...
CTRL_KERNEL_FN(updateCell_3d27_zBorder, FPGA, NDRANGE, KHitTileR_arg(float, matrix), KHitTileR_arg(float, matrixCopy),
			   K_arg(EpsilodCoords, global_coords), KHitTileR_arg(float, stencil), K_arg(float, factor),
			   K_arg(Epsilod_ext, ext_params)) {
	hit(matrix, thr_i, thr_j, thr_k) = (hit(matrixCopy, thr_i - 1, thr_j - 1, thr_k - 1) +
										hit(matrixCopy, thr_i - 1, thr_j - 1, thr_k) +
