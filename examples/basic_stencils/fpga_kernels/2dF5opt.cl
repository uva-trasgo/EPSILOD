/**
 * @file basic_stencils/fpga_kernels/2dF5opt.cl
 * @brief Epsilod: Example with several key stencils. Optimized FPGA 2dF5 kernel code.
 *
...
#define BLOCK_WIDTH      (HALO_BLOCK_WIDTH - RAD) // Without halos
...
#define SR_BASE (RAD * HALO_BLOCK_WIDTH) // Elements whose input is a posterior shift
// SR dims:      yyy   xxxxxxxxxxxxxxxx     register element
...
#define SR_CENTER    (SR_BASE)                // Index of the center element of the shift register
...
EPSILOD_FPGA_BASIC_STENCIL(2dF5, matrix, matrixCopy) {
...
#define SR_BASE_XBORDER (2 * RAD * HALO_BLOCK_WIDTH_XBORDER + 2)
...
EPSILOD_FPGA_BASIC_STENCIL(2dF5_xBorder, matrix, matrixCopy) {
