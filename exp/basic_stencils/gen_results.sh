...
DEVICE_FILE_PATH="$ROOT_DIR/extern/controllers/examples/Device_Selection_Files/dev_cuda0"
...
# 1.3. DIRECTORY WITH THE RESULT FILES
...
function doTest() {
	echo -e "\e[1mGenerating result $5 $2 $3 $4:\e[0m"
	...
	# CHECK THE CONTENTS OF THE RESULTS FILE
		...
		CHECK=""
		mv $RESULT_FILE $RESULT_DIR/Result.$5.$3.$4 >/dev/null
	fi
}
...
# EXTRA. COMPRESS THE RESULTS
tar cf $RESULT_DIR.tar $RESULT_DIR
xz -9e -v --lzma2=dict=1536M $RESULT_DIR.tar
