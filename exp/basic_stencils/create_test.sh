...
APP_NAME="Create test files for basic_stencils"
ROOT_DIR="../.."
...
CPUS_PER_TASK=24
MACHINES=("manticore")
DEVICE_FILES=("allCuda.conf")
#MACHINES=("gorgon")
#DEVICE_FILES=("allCPUs.conf")
PROCS=(2)
ITERATIONS=(1000)
SIZES1D=("100")
SIZES2D=("100 100")
...
function doTest() {
    ...
    $1 -n $3 ./$2 $6 $4 $5 $7 >/dev/null 2>check.err
	...
	if [ ! -r $RESULT_FILE ]; then
		...
		mv $RESULT_FILE $RESULT_DIR/Result.$6.$size_nospaces.$5
        echo OK
	fi
}
